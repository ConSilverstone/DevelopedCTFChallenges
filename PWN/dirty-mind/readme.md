...
Solution: Secure shell connection that can be bruteforced as the password is weak (butthole) to gain access. Either by a lucky guess or using Hydra. Good example on <a href="https://www.geeksforgeeks.org/linux-unix/how-to-use-hydra-to-brute-force-ssh-connections/"> geeksforgeeks</a>.
<details>
